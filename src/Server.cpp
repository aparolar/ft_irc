...
/*   Updated: 2024/05/15 10:29:04 by irifarac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Server::Server(void) : _m_g_run_server(false), _m_port(6667), _m_password("default"), _m_fd_server(0)
{
}

Server::Server(char **argv)
{
	_m_port = std::atoi(argv[1]);
